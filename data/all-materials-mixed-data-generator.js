  ...
  for (let i = 0; i < 10; i++) {
    ...
    for (let m = 0; m < 3; m++) {
      for (let j = 0; j < materials.length; j++) {
        ...
        const registration = new Registration(orgId, referenceNumber, street)
    ...
    for (let j = 0; j < materials.length * 3; j++) {
      ...
      data.registrations[j].validFrom = '2026-01-01'
    ...
    data.submitterContactDetails.email = 'AM_AllTypes_' + replacementEmail

    replacementEmail = 'AM_AllTypes_' + replacementEmail

...
export const config = {
  ...
  baseUrl: `https://epr-backend-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `epr-backend-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `epr-backend-journey-tests-${process.env.ENVIRONMENT}`
        },
